    ...
    <div className='px-3 py-4 bg-gray-300/40'>
      <div className='flex flex-wrap items-center justify-between gap-2'>
        ...
        <div className='flex items-center'>
          ...
          <div className='ml-2'>
            <button className='h-8 px-3 rounded-tl-sm rounded-bl-sm cursor-not-allowed bg-white/60 hover:bg-slate-100'>
              <svg
            ...
            <button className='h-8 px-3 bg-white rounded-tr-sm rounded-br-sm hover:bg-slate-100'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                fill='none'
                viewBox='0 0 24 24'
